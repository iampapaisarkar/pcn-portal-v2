...
class LocationApplicationController extends Controller
{
            ...
            if($checkboxes == true){
                foreach($request->check_box_bulk_action as $registration_id => $registration){
                    ...
                    if($Registration->type == 'ppmv'){
                        ...
                        // Store Report 
                        \App\Http\Services\Reports::storeApplicationReport($Registration->id, 'ppmv', 'location_inspection', 'pending', $Registration->user->state, null);
                    }
                    if($Registration->type == 'community_pharmacy'){
                        ...
                        // Store Report 
                        \App\Http\Services\Reports::storeApplicationReport($Registration->id, 'community_pharmacy', 'location_inspection', 'pending', $Registration->other_registration->company->state, null);
                    }
                    if($Registration->type == 'distribution_premises'){
                        ...
                        // Store Report 
                        \App\Http\Services\Reports::storeApplicationReport($Registration->id, 'distribution_premises', 'location_inspection', 'pending', $Registration->other_registration->company->state, null);
                    }
    ...
    public function ppmvLocationApprove(Request $request){
        ...
        if($application){
            ...
            // Store Report 
            \App\Http\Services\Reports::storeApplicationReport($application->id, 'ppmv', 'location_inspection', 'pending', $application->user->state, null);
    ...
    public function communityLocationApprove(Request $request){
        ...
        if($application){
            ...
            // Store Report 
            \App\Http\Services\Reports::storeApplicationReport($application->id, 'community_pharmacy', 'location_inspection', 'pending', $application->other_registration->company->state, null);
    ...
    public function distributionLocationApprove(Request $request){
        ...
        if($application){
            ...
            // Store Report 
            \App\Http\Services\Reports::storeApplicationReport($application->id, 'distribution_premises', 'location_inspection', 'pending', $application->other_registration->company->state, null);
