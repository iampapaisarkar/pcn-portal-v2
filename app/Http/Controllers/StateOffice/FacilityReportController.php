...
class FacilityReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('stateoffice.registration-inspection-report.index', compact('applications'));
    }
        ...
        if($application){
            ...
            if($application->status == 'facility_no_recommendation'){
                $alert = [
                    ...
                    'color' => 'danger',
                    'download-link' => route('ppmv-registration-inspection-report-download', $application->id),
                ];
            }
            ...
            return view('stateoffice.registration-inspection-report.ppmv-registration-show', compact('application', 'alert'));
        }else{
            return abort(404);
        }
    }
