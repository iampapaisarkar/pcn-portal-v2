...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        @endphp
        <form method="POST" action="{{route('manufacturing-registration-update', $application->id)}}" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary">Update Facility Approval Application</button>
                </div>
            </div>
        </form>
    </div>
