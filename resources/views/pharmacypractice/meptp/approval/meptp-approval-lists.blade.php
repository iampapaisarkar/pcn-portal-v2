...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'MEPTP Applications - Documents Approval Pending', 'route' => 'meptp-approve-batches'])
<div class="row">
<div class="col-lg-12 col-md-12">
    <div class="card text-left">
    <div class="card-body">
        <h4>MEPTP Applications - Documents Approval Pending</h4>
        <div class="table-responsive">
            <div class="row m-0">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <form method="GET" action="{{ route('meptp-approval-lists') }}">
                    @csrf
                        <label>Search:
            ...
            <table class="display table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('meptp-approval-show') }}?application_id={{$application->id}}&school_id={{$application->traing_centre}}&vendor_id={{$application->user->id}}">
