...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'MEPTP Applications - Documents Documents Approved', 'route' => 'meptp-approved-batches'])
<div class="row">
    <div class="col-lg-12 col-md-12">
        <h4 class=" mb-6">MEPTP Applications - Documents Documents Approved</h4>
        <div class="row">
