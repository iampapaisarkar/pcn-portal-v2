...
<div class="col-lg-12 col-md-12">
    ...
    <div class="card-body">
        ...
        <h3>Inspection Report: Recommended</h3> <a href="{{route('download-ppmv-report', $application->id)}}" class="btn btn-rounded btn-success ml-3">Download Inspection Report</a></div>
        </div>
        @else
        <div class="alert alert-card alert-danger" role="alert">
        <h3>Inspection Report: Not Recommended</h3> <a href="{{route('download-ppmv-report', $application->id)}}" class="btn btn-rounded btn-danger ml-3">Download Inspection Report</a>
        </div>
        @endif
