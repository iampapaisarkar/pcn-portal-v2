...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'Location Approval Banner', 'route' => 'state-office-banner-collected.index'])
<div class="row">
<div class="col-lg-12 col-md-12">
    <div class="card text-left">
    <div class="card-body">
        <h4>Location Approval Banner - Collected</h4>
        <div class="table-responsive">
            <div class="row m-0">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <form method="GET" action="{{ route('state-office-banner-collected.index') }}">
                    @csrf
                        <label>Search:
