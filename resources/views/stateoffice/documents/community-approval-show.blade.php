...
<div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card-body">
                <h5>Community Pharmacy Location Approval - Documents Verification</h5>
                ...
                <div class="row">
                    <form action="{{route('state-office-documents-community-approve')}}" method="POST" id="approveForm">
                    @csrf
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <form id="quriedForm" class="w-100" method="POST" action="{{route('state-office-documents-community-reject')}}" enctype="multipart/form-data">
                    @csrf
