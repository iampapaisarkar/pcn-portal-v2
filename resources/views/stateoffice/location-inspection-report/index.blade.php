...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'Location Approval Reports', 'route' => 'state-office-location-reports.index'])
<div class="row">
<div class="col-lg-12 col-md-12">
    <div class="card text-left">
    <div class="card-body">
        <h4>Location Approval - Inspection Reports</h4>
        <div class="table-responsive">
            <div class="row m-0">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <form method="GET" action="{{ route('state-office-location-reports.index') }}">
                    @csrf
                        <label>Search:
            ...
            <table class="display table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($application->type == 'ppmv')
                            <a href="{{ route('state-office-location-report-ppmv-show') }}?application_id={{$application->id}}&user_id={{$application->user->id}}">
