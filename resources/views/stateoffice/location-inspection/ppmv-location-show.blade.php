...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'Location Approval Inspection', 'route' => 'state-office-locations.index'])
<div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card-body">
                <h5>Location Approval Inspection - Details</h5>
                ...
                <div class="row">
                    <form action="{{route('state-office-locations-ppmv-inspection-update')}}" method="POST" id="approveForm" enctype="multipart/form-data">
                    @csrf
