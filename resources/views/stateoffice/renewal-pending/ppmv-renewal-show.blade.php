...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'Facility Licecne ', 'route' => 'state-renewal-pending.index'])
<div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card-body">
                ...
                <div class="row">
                    <form action="{{route('state-renewal-ppmv-inspection')}}" method="POST" id="approveForm" enctype="multipart/form-data">
                    @csrf
