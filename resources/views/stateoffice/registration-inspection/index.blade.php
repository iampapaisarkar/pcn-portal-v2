...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'Facility Inspection', 'route' => 'state-office-registration.index'])
<div class="row">
        ...
        <div class="table-responsive">
            <div class="row m-0">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <form method="GET" action="{{ route('state-office-registration.index') }}">
                    @csrf
                        <label>Search:
            ...
            <table class="display table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($application->type == 'ppmv')
                            <a href="{{ route('state-office-registration-ppmv-show') }}?application_id={{$application->id}}&user_id={{$application->user->id}}">
