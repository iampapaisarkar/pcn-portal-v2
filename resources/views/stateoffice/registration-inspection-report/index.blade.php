...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'Facility Inspection Report', 'route' => 'state-office-registration-reports.index'])
<div class="row">
        ...
        <div class="table-responsive">
            <div class="row m-0">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <form method="GET" action="{{ route('state-office-registration-reports.index') }}">
                    @csrf
                        <label>Search:
            ...
            <table class="display table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if($application->status == 'facility_no_recommendation')
                        ...
                        @endif -->
                        @if($application->status == 'facility_full_recommendation')
                        <td><span class="badge badge-pill m-1 badge-success">FULL RECOMMENDATION</span></td>
                        @endif

                        <td>
                            @if($application->type == 'ppmv')
                            <a href="{{ route('state-office-registration-report-ppmv-show') }}?application_id={{$application->id}}&user_id={{$application->user->id}}">
