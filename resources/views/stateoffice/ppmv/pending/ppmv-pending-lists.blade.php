...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'Tiered PPMV Registration - Documents Review Pending', 'route' => 'ppmv-pending-applications'])
<div class="row">
    <div class="col-lg-12 col-md-12">
        <h4 class=" mb-6">Tiered PPMV Registration - Documents Review Pending</h4>
        <div class="table-responsive">
            <div class="row m-0">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <form method="GET" action="{{ route('ppmv-pending-applications') }}">
                    @csrf
                        <label>Search:
