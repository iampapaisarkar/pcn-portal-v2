...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'Renewal', 'route' => 'hospital-renew'])
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card-body">
            <form method="POST" action="{{route('hospital-renewal-submit')}}" enctype="multipart/form-data" novalidate>
            @csrf
            <input name="registration_id" type="hidden" value="{{$registration->registration->id}}" />
            <input name="hospital_registration_id" type="hidden" value="{{$registration->hospital_pharmacy->id}}" />
                <div class="row">
                    <div class="form-group col-md-12">
                        <h3>Renewal Year: {{ date('Y') }}<h3>
                    </div>
