...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'Update Renewal & Re-submit', 'route' => 'hospital-renew'])
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card-body">
            <form method="POST" action="{{ route('hospital-renewal-update', $registration->id) }}" enctype="multipart/form-data" novalidate>
            @csrf
