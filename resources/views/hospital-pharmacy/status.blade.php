                ...
                <div class="form-row">
                    <div class="col-md-12">
                        <div class="alert alert-card alert-{{app('App\Http\Services\HospitalRegistrationInfo')->status()['color']}}" role="alert">
                            ...
                            <br>
                            <br>
                            <a href="{{app('App\Http\Services\HospitalRegistrationInfo')->status()['download-link']}}" target="_blank" class="btn btn-{{app('App\Http\Services\HospitalRegistrationInfo')->status()['color']}} text-white btn-rounded ">Download Inspection Report</a>
                            @endif
                        </div>
                    </div>
