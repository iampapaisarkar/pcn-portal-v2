                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @endif
                            @if($document->registration->type == 'ppmv')
                            <a href="{{ route('registry-renewal-pending-ppmv-show') }}?renewal_id={{$document->id}}&user_id={{$document->user->id}}">
                                <button class="btn btn-success btn-sm" type="button"><i class="nav-icon i-Pen-2"></i></button>
                            </a>
                            @endif
                            @if($document->registration->type == 'community_pharmacy')
                            <a href="{{ route('registry-renewal-pending-community-show') }}?renewal_id={{$document->id}}&user_id={{$document->user->id}}">
                                <button class="btn btn-success btn-sm" type="button"><i class="nav-icon i-Pen-2"></i></button>
                            </a>
                            @endif
                            @if($document->registration->type == 'distribution_premises')
