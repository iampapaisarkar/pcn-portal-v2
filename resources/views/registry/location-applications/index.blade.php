...
<div class="col-lg-12 col-md-12">
    <form id="approvedForm" class="w-100" method="POST" action="{{ route('registry-locations-approve-all') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="table-responsive">
            <div class="row m-0">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <form method="GET" action="{{ route('registry-locations.index') }}">
                    @csrf
                        <label>Search:
