...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'Location Inspection - Inspection List', 'route' => 'monitoring-inspection-flt.index'])
<div class="row">
        ...
        <div class="table-responsive">
            <div class="row m-0">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <form method="GET" action="{{ route('monitoring-inspection-flt.index') }}">
                    @csrf
                        <label>Search:
            ...
            <table class="display table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($document->type == 'community_pharmacy')
                            <a href="{{ route('monitoring-inspection-flt-community-show') }}?registration_id={{$document->id}}&user_id={{$document->user->id}}">
