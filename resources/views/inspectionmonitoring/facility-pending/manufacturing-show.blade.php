...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'Registration - Location Inspection', 'route' => 'monitoring-inspection-flt.index'])
<div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card-body">
               ...
               <x-manufacturing-registration-show
                ...
                <div class="row">
                    <form action="{{route('monitoring-inspection-flt-manufacturing-update')}}" method="POST" id="approveForm" enctype="multipart/form-data">
                    @csrf
