...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'Facility Inspection Report', 'route' => 'renewal-pending.index'])
<div class="row">
<div class="col-lg-12 col-md-12">
    <form id="approvedForm" class="w-100" method="POST" action="{{ route('renewal-pending-approve-all') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="table-responsive">
            <div class="row m-0">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <form method="GET" action="{{ route('renewal-pending.index') }}">
                    @csrf
                        <label>Search:
            ...
            <table class="display table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @endif
                        @if($document->registration->type == 'manufacturing_premises')
                        <td>Pharmaceutical Manufacturing Premises Registration Approval Application</td>
                        @endif
                        ...
                        <td>
                            ...
                            @endif
                            @if($document->type == 'manufacturing_premises_renewal')
                            <a href="{{ route('renewal-pending-manufacturing-show') }}?renewal_id={{$document->id}}&user_id={{$document->user->id}}">
                                <button class="btn btn-success btn-sm" type="button"><i class="nav-icon i-Pen-2"></i></button>
                            </a>
                            @endif
                        </td>
