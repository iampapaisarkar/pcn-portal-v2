...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'Renewal', 'route' => 'ppmv-renew'])
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card-body">
            <!--begin::form-->
            <form method="POST" action="{{ route('ppmv-renewal-update', $registration->id) }}" enctype="multipart/form-data" novalidate>
            @csrf
            <input name="registration_id" type="hidden" value="{{$registration->registration->id}}" />
                ...
                <div class="card-footer">
                    <div class="mc-footer">
                        <div class="row">
                            <div class="col-lg-12">
                                <button type="submit" class="btn  btn-primary m-1" id="save" name="save">Update Renewal
                                    Application</button>
                            </div>
                        </div>
                    </div>
