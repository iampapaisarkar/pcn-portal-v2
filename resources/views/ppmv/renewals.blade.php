        ...
        <div class="card text-left">
            ...
            @if(app('App\Http\Services\PPMVApplicationInfo')->canAccessRenewalPage()['response'])
                ...
                @else
                    ...
                    <h5>You can renew on {{app('App\Http\Services\PPMVApplicationInfo')->licenceRenewalYearCheck()['renewal_date']}}</h5>
                    @endif
                @endif
                    ...
                    <table class="display table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endif
                                @if($renewal->status == 'licence_issued')
                                <a target="_blank" href="{{route('ppmv-download-licence', $renewal->id)}}"><button class="btn btn-info btn-icon btn-sm m-0" type="button"> <span class="ul-btn__icon"><i class="i-Gear-2"></i></span> <span class="ul-btn__text">LICENCE</span></button></a>
                                @endif
                                </td>
                            </tr>
                            @endforeach
