    ...
    <div class="col-lg-12 col-md-12">
        ...
        @else
            <div class="alert alert-card alert-{{app('App\Http\Services\BasicInformation')->canSubmitPPMVApplication()['color']}}" role="alert">
                ...
                @if(isset(app('App\Http\Services\BasicInformation')->canSubmitPPMVApplication()['caption']))
                <br><br>
                <div>REASON: {{app('App\Http\Services\BasicInformation')->canSubmitPPMVApplication()['caption']}}</div>
                @endif
