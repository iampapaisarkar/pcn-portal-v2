...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'MEPTP Application Update', 'route' => 'meptp-application'])
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card-body">
            <!--begin::form-->

            <form method="POST" action="{{ route('meptp-application-update', $application->id) }}" enctype="multipart/form-data" novalidate>
            @csrf
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="custom-file mb-3">
                            ...
                            <label class="custom-file-label " for="inputGroupFile01"
                                aria-describedby="inputGroupFileAddon02" id="inputGroupFile01previewLabel">{{$application->birth_certificate}}</label>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="custom-file mb-3">
                            ...
                            <label class="custom-file-label " for="inputGroupFile02"
                                aria-describedby="inputGroupFileAddon02" id="inputGroupFile02previewLabel">{{$application->educational_certificate}}</label>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="custom-file mb-3">
                            ...
                            <label class="custom-file-label " for="inputGroupFile03"
                                aria-describedby="inputGroupFileAddon02" id="inputGroupFile03previewLabel">{{$application->academic_certificate}}</label>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        value="{{ $application->shop_address }}"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="is_registeredField" required name="is_registered"
                            ...
                            @if($application->is_registered == true)
                            <option selected hidden value="yes">Yes</option>
                            @elseif($application->is_registered == false)
                    ...
                    <div id="ppmvl_noField" style="{{$application->is_registered == true ? 'display: block;' : 'display: none;'}}" class="form-group col-md-4">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        @foreach($schools as $school)
                            @if($application->traing_centre == $school->id)
                ...
                <div class="card-footer">
                    <div class="mc-footer">
                        <div class="row">
                            <div class="col-lg-12">
                                <button type="submit" class="btn  btn-primary m-1" id="save" name="save">Update MEPTP
                                    Application</button>
