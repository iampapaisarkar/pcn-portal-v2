...
@section('content')
@include('layouts.navbars.breadcrumb', ['page' => 'Location Approval Edit', 'route' => 'location-approval-form'])
<div class="row">
    <div class="col-lg-12 col-md-12">
    @if(app('App\Http\Services\CommunityDistributionInfo')->canSubmitFacilityApplication()['success'] == true)
        @php 
        ...
        @endphp
        <form method="POST" action="{{route('facility-registration-form-submit', $application->id)}}" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <input name="firstname" class="form-control @error('firstname') is-invalid @enderror"
                        id="firstname1" type="text" placeholder="Enter your first name" value="{{$application->other_registration->firstname}}"/>
                    @error('firstname')
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <input name="middlename" class="form-control @error('middlename') is-invalid @enderror" id="middlename1"
                        type="text" placeholder="Enter your middle name" value="{{$application->other_registration->middlename}}"/>
                    @error('middlename')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <input name="surname" class="form-control @error('surname') is-invalid @enderror" id="surname1"
                        type="text" placeholder="Enter your sur name" value="{{$application->other_registration->surname}}"/>
                    @error('surname')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <input name="email" class="form-control @error('email') is-invalid @enderror"
                        id="email1" type="email" placeholder="Enter your email address" value="{{$application->other_registration->email}}"/>
                    @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <input name="phone" class="form-control @error('phone') is-invalid @enderror" id="phone1"
                        type="text" placeholder="Enter your phone" value="{{$application->other_registration->phone}}"/>
                    @error('phone')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <select class="form-control @error('gender') is-invalid @enderror" name="gender">
                        ...
                        <option {{$application->other_registration->gender == 'Male' ? 'selected' : ''}} value="Male">Male</option>
                        <option {{$application->other_registration->gender == 'Female' ? 'selected' : ''}} value="Female">Female</option>
                    </select>
                    @error('gender')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <input name="doq" class="form-control @error('doq') is-invalid @enderror"
                        id="doq1" type="date" placeholder="Enter your date of qualification" value="{{$application->other_registration->doq}}"/>
                    @error('doq')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <input name="residental_address" class="form-control @error('residental_address') is-invalid @enderror" id="residental_address1"
                        type="text" placeholder="Enter your residental address" value="{{$application->other_registration->residental_address}}" />
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <input name="annual_licence_no" class="form-control @error('annual_licence_no') is-invalid @enderror" id="annual_licence_no1"
                        type="text" placeholder="Enter your annual licence no" value="{{$application->other_registration->annual_licence_no}}" />
            ...
            <div class="row">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary">Submit Facility Registration</button>
                </div>
            </div>
        </form>
    @else
        <div class="alert alert-card alert-warning" role="alert">
            {{app('App\Http\Services\CommunityDistributionInfo')->canSubmitFacilityApplication()['message']}}
        </div>
    @endif
    </div>
</div>
